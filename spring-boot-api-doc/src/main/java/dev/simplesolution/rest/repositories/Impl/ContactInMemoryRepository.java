...
"john@simplesolution.dev", "123-456-789", "address 123, street 1, city1"));

contacts.add(new Contact(2L, "Emerson", "Wilks",
"emerson@simplesolution.dev", "123-456-788", "address 456, street 2,city 1"));

contacts.add(new Contact(3L, "Wade", "Savage",
"wade@simplesolution.dev", "123-456-787", "address 789, street 3, city1"));

contacts.add(new Contact(4L, "Star", "Lott",
"star@simplesolution.dev", "123-456-786", "address 234, street 4, city1"));

contacts.add(new Contact(5L, "Claudia", "James",
"claudia@simplesolution.dev", "123-456-785", "address 678, street 5,city 1"));
}
